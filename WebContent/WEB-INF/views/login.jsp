...
<title>登录|公交在线查询系统</title>
<meta name="keywords" content="公交在线查询系统">
</head>
<body>

<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">公交在线查询系统</h2>
</div>
